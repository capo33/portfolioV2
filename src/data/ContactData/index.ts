...
export const ContactObj: IHomeMainObj<string> = {
  ...
  description:"I am available for freelance work. If you have a project that you would like to get started, think you need my help with something or just fancy saying hello, then please get in touch :)",
